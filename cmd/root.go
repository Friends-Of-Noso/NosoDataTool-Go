...
var rootCmd = &cobra.Command{
	Use:   "nosodatatoolgo",
	Short: "This tool allows to query Noso data files",
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".nosodatatoolgo" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigType("yaml")
		viper.SetConfigName(".nosodatatoolgo")
	}
